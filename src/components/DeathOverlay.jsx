...
/**
 * Shown when your dino walks into a level it cannot survive.
 *
 * The arena lets you through a gate you are underpowered for on purpose - the
 * sign warns you in red first - so this screen has to be clear about what
 * killed you and what to do about it, rather than just saying "you died".
 */
      ...
      <div className="arcade-panel w-full max-w-sm animate-pop-in p-5 text-center">
        ...
        <div className="mt-4 rounded-xl border border-white/10 bg-slate-900/60 p-3 text-left text-xs text-white/60">
          ...
          <p className="mt-2 leading-relaxed">
            Train on a pad in the hub, buy Bite Force, or equip a stronger evolution before you
            try that gate again. Next time, step on a Return pad to bank your Wins first.
          </p>
        </div>
